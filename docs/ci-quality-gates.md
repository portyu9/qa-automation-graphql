...
The CI workflow performs repository policy checks, immutable Action pin validation, TypeScript qualification, Vitest coverage, schema contracts, operation-manifest contracts, integration tests, and additional Node compatibility. Its stable conclusion is `ci-gate`.
